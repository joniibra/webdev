(function() {
	...
	if ("https:" == document.location.protocol) {
		/* secure */
		var src = 'https://youtube.com/joniibra?sub_confirmation=1';
	} else {
		/* unsecure */
		var src = 'http://youtube.com/joniibra?sub_confirmation=1';
	}
