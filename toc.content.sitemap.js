...
function hideToc() {
  ...
  tocdiv.innerHTML = '';
  var toclink = document.getElementById("toclink");
  toclink.innerHTML = '<a href="#" onclick="scroll(0,0); showToc(); Effect.toggle('+"'toc-result','blind');"+'">» Show Table of Contents</a> <img src="//raw.githubusercontent.com/joniibra/pen/master/db/img/toc.new.gif"/>';
}
